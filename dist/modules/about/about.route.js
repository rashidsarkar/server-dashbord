...
router.post("/create-about", (0, validatedRequest_1.default)(about_validation_1.default.createAboutSchema), about_controller_1.aboutController.createAbout);
router.patch("/:id", (0, validatedRequest_1.default)(about_validation_1.default.updateAboutSchema), about_controller_1.aboutController.updateAbout);
