...
router.post("/create-blog", (0, auth_1.default)(), (0, validatedRequest_1.default)(blog_validation_1.default.createBlogSchema), blog_controller_1.blogController.createBlog);
router.patch("/:id", (0, auth_1.default)(), (0, validatedRequest_1.default)(blog_validation_1.default.updateBlogSchema), blog_controller_1.blogController.updateBlog);
